...
public class LockFreeQueueM<T> implements Queue<T> { // implementa la interfaz Queue porque necesariamente necesitamos enqueue y dequeue
    private AtomicReference<Node<T>> head;
    private AtomicReference<Node<T>> tail;

//////////////////////////////////////////////////////////////

public LockFreeQueueM(){ // constructor de la Cola
    ...
    while(true){
        ...
        if(first == head.get()){
            if (first == last){
                ...
                T value = next.valor; // lee el valor antes de encolar
